namespace Tokiota.Store.Demo.Controllers
{
    ...
    public class ProductController : Controller
    {
        ...
        public ProductController(ITracer tracer, ICatalogService service, IImageStorageService imageService, ITopListService topService, IMapper<Product, ProductModel> listMapper, IMapper<Product, EditProductModel> editMapper)
        {
            this.tracer = tracer;
        ...
        {
            this.tracer.Info("Viewing details of product #" + id);
            try
            {
